...
// CORREGIDO: Agregamos "type" antes de BoardProps
...
import type { WidgetConfig, WidgetDataType, StoredWidgetPlacement } from './interfaces';
...
export function getBoardWidgets(layout: ReadonlyArray<StoredWidgetPlacement>): BoardProps.Item<WidgetDataType>[] {
