...
// Importa los datos limpios desde tu archivo externo
import { m2Sec1Data, m2Sec2Data, m2Sec3Data } from './mondini2Data';
...
export default function Mondini2Details() {
  ...
  const [flashbarItems, setFlashbarItems] = useState<any[]>([
    {
      ...
      content: (
        <Box fontSize="body-s">
          ...
          general de la Mondini 2 antes de iniciar lavado.
        </Box>
      ),
      id: 'msg_loto',
    },
  ...
  // ==========================================
  // GENERADOR DE PDF CORPORATIVO (TEMPLATE AWS - MONDINI 2)
  // ==========================================
